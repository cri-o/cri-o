...
[v1.18.0...244688d](https://github.com/cri-o/cri-o/compare/v1.18.0...244688da4de7f0a7ea3f894ed3bfb185194bc248) on Wed, 15 Jul 2020 14:52:00 UTC.

## Downloads

Download the static release bundle via our Google Cloud Bucket:
[crio-244688da4.tar.gz][0]

[0]: https://storage.googleapis.com/k8s-conform-cri-o/artifacts/crio-244688da4.tar.gz
...
- go.etcd.io/etcd: 3cf2f69 → 54ba958
...
- golang.org/x/sys: ea54a3c → ed371f2
- golang.org/x/text: v0.3.2 → v0.3.3
- golang.org/x/tools: 9497f49 → c00d67e
...
- k8s.io/kubernetes/staging/src/k8s.io/api: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/apiextensions-apiserver: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/apimachinery: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/apiserver: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/cli-runtime: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/client-go: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/cloud-provider: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/cluster-bootstrap: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/code-generator: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/component-base: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/cri-api: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/csi-translation-lib: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kube-aggregator: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kube-controller-manager: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kube-proxy: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kube-scheduler: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kubectl: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/kubelet: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/legacy-cloud-providers: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/metrics: 7879fc1 → 2cbdfec
- k8s.io/kubernetes/staging/src/k8s.io/sample-apiserver: 7879fc1 → 2cbdfec
- k8s.io/kubernetes: v1.18.1 → v1.19.0-rc.1
- k8s.io/release: v0.2.5 → v0.3.2
- k8s.io/system-validators: v1.0.4 → v1.1.2
- k8s.io/utils: 6496210 → 6e3d28b
