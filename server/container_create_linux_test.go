...
func TestAddOCIBindsForDev(t *testing.T) {
	...
	_, binds, _, _, err := sut.addOCIBindMounts(t.Context(), ctr, "", "", nil, false, false, false, false, false, "", "")
	if err != nil {
		t.Error(err)
	}
...
func TestAddOCIBindsRROMounts(t *testing.T) {
	...
	_, binds, _, _, err := sut.addOCIBindMounts(ctx, ctr, "", "", nil, false, false, false, false, true, "", "")
	if err != nil {
...
func TestAddOCIBindsRROMountsError(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.description, func(t *testing.T) {
			...
			_, _, _, _, err = sut.addOCIBindMounts(ctx, ctr, "", "", nil, false, false, false, false, tc.rroSupport, "", "")
			if err == nil {
...
func TestAddOCIBindsCGroupRW(t *testing.T) {
	...
	//nolint: dogsled
	_, _, _, _, err = sut.addOCIBindMounts(t.Context(), ctr, "", "", nil, false, false, true, false, false, "", "")
	if err != nil {
		t.Error(err)
	}
	...
	//nolint: dogsled
	_, _, _, _, err = sut.addOCIBindMounts(t.Context(), ctr, "", "", nil, false, false, false, false, false, "", "")
	if err != nil {
		t.Error(err)
	}
...
func TestAddOCIBindsErrorWithoutIDMap(t *testing.T) {
	...
	//nolint: dogsled
	_, _, _, _, err = sut.addOCIBindMounts(t.Context(), ctr, "", "", nil, false, false, false, true, false, "", "")
	if err != nil {
		t.Errorf("%v", err)
	}
}
