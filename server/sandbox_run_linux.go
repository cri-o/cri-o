...
func (s *Server) configureGeneratorForSandboxNamespaces(hostNetwork, hostIPC, hostPID bool, sb *libsandbox.Sandbox, g generate.Generator, sysctls map[string]string) (cleanupFuncs []func() error, err error) {
