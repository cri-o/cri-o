...
[--automatic-reload-mirror-registry]
...
**--automatic-reload-mirror-registry**: if true, CRI-O will automatically reload the mirror registry when there is an update to the 'registries.conf.d' directory.
