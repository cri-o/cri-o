...
[v1.28.1...d496db2](https://github.com/cri-o/cri-o/compare/v1.28.1...d496db20c1a30be3242e0b537d0937c10f13ccc7) on Fri, 01 Dec 2023 08:10:00 UTC.

## Downloads

Download one of our static release bundles via our Google Cloud Bucket:

- [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sha256sum)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sig)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.cert)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.sig)
  - [cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.cert)
- [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sha256sum)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sig)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.cert)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.sig)
  - [cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx.cert)

To verify the artifact signatures via [cosign](https://github.com/sigstore/cosign), run:

```console
> export COSIGN_EXPERIMENTAL=1
> cosign verify-blob cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz \
    --certificate-identity https://github.com/cri-o/cri-o/.github/workflows/test.yml@refs/tags/d496db20c1a30be3242e0b537d0937c10f13ccc7 \
    --certificate-oidc-issuer https://token.actions.githubusercontent.com \
    --certificate-github-workflow-repository cri-o/cri-o \
    --certificate-github-workflow-ref refs/tags/d496db20c1a30be3242e0b537d0937c10f13ccc7 \
    --signature cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.sig \
    --certificate cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.cert
```

To verify the bill of materials (SBOM) in [SPDX](https://spdx.org) format using the [bom](https://sigs.k8s.io/bom) tool, run:

```console
> tar xfz cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz
> bom validate -e cri-o.amd64.d496db20c1a30be3242e0b537d0937c10f13ccc7.tar.gz.spdx -d cri-o
```
