...
func (m *MockRuntimeImpl) CreateNamespaces(arg0 context.Context, arg1 string, arg2 *nsmgr.PodNamespacesConfig) (map[nsmgr.NSType]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateNamespaces", arg0, arg1, arg2)
...
func (mr *MockRuntimeImplMockRecorder) CreateNamespaces(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateNamespaces", reflect.TypeOf((*MockRuntimeImpl)(nil).CreateNamespaces), arg0, arg1, arg2)
}
