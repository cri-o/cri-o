...
func (m *MockLibartifactStore) Inspect(ctx context.Context, nameOrDigest string) (*libartifact.Artifact, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Inspect", ctx, nameOrDigest)
...
func (mr *MockLibartifactStoreMockRecorder) Inspect(ctx, nameOrDigest any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Inspect", reflect.TypeOf((*MockLibartifactStore)(nil).Inspect), ctx, nameOrDigest)
}
