...
@test "image content cache GC removes blobs on image delete" {
	...
	# Verify blob files are also removed from disk.
	disk_blob_count=$(find "$BLOB_CACHE_DIR/blobs" -type f | wc -l)
