...
func TestMetaHostportManager(t *testing.T) {
	...
	expectedLines := map[string]bool{
		...
		"-A KUBE-HP-IJHALPHTORMHHPPK -m comment --comment \"pod1_ns1 hostport 8080\" -s 192.168.2.7/32 -j KUBE-MARK-MASQ":                                   true,
		...
		"-A KUBE-HP-63UPIDJXVRSZGSUZ -m comment --comment \"pod1_ns1 hostport 8081\" -s 192.168.2.7/32 -j KUBE-MARK-MASQ":                                   true,
		...
		"-A KUBE-HP-XU6AWMMJYOZOFTFZ -m comment --comment \"pod1_ns1 hostport 8083\" -s 192.168.2.7/32 -j KUBE-MARK-MASQ":                                   true,
		...
		"-A KUBE-HP-CHN66X54O4WXZ5CW -m comment --comment \"pod1_ns1 hostport 8084\" -s 192.168.2.7/32 -j KUBE-MARK-MASQ":                                   true,
		...
		"-A KUBE-HP-WFBOALXEP42XEMJK -m comment --comment \"pod4_ns2 hostport 8443\" -s 192.168.2.2/32 -j KUBE-MARK-MASQ":                                   true,
