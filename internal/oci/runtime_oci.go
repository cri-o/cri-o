...
// CreateNamespaces is not supported by the OCI runtime.
func (r *runtimeOCI) CreateNamespaces(context.Context, string, *nsmgr.PodNamespacesConfig) (map[nsmgr.NSType]string, error) {
	return nil, nil
}
