...
var _ = Describe("high_performance_hooks", func() {
	...
	Describe("setIRQLoadBalancingUsingDaemonCommand", func() {
		...
		Context("should set the irq bit mask", func() {
			It("from false to true successfully", func() {
			...
			It("only if false was called first", func() {
				...
				verifySetIRQLoadBalancing(h, true, "00000000,00003033", "00000000,00003033")
			})
		})
	})
	...
	Describe("setIRQLoadBalancingUsingServiceRestart", func() {
		...
		Context("should set the irq bit mask", func() {
			It("only if false was called first", func() {
				...
				verifySetIRQLoadBalancing(h, true, "00000000,00003033", "00000000,00003033", "ffffffff,ffffcffc", "ffffffff,ffffcffc")
			})
			It("from false to true successfully", func() {
				h := &HighPerformanceHooks{
					irqBalanceConfigFile:      irqBalanceConfigFile,
	...
	Describe("setIRQLoadBalancing with housekeeping CPUs", func() {
		...
		Context("with enabled equals to false", func() {
			It("should set the irq bit mask without housekeeping CPUs", func() {
				...
				c, sb := createContainerSandbox("4,5,6,7", map[string]string{})
				verifySetIRQLoadBalancing(h, c, sb, false, "00000000,ffffffff", "00000000,ffffff0f", "ffffffff,000000f0", "ffffffff,000000f0", "", false)
			})
			...
			It("should set the irq bit mask with housekeeping CPUs when no thread siblings files are present", func() {
				...
				verifySetIRQLoadBalancing(h, c, sb, false, "00000000,ffffffff", "00000000,ffffff1f", "ffffffff,000000f0", "ffffffff,000000e0", "4", false)
			})
			...
			It("should set the irq bit mask with housekeeping CPUs and siblings (topology 2)", func() {
				...
				verifySetIRQLoadBalancing(h, c, sb, false, "00000000,ffffffff", "00000000,ffffff3f", "ffffffff,000000f0", "ffffffff,000000c0", "4-5", false)
			})
			...
			It("should set the irq bit mask with housekeeping CPUs and siblings (topology 4)", func() {
				...
				verifySetIRQLoadBalancing(h, c, sb, false, "00000000,ffffffff", "00000000,fffff0ff", "ffffffff,000000f0", "ffffffff,00000f00", "4-7", false)
			})
			...
			It("should fail with invalid siblings files", func() {
				...
				verifySetIRQLoadBalancing(h, c, sb, false, "00000000,ffffffff", "00000000,fffff0ff", "ffffffff,000000f0", "ffffffff,00000f00", "4-7", true)
			})
		})
	})
