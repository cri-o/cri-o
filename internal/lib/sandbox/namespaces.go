...
func (s *Sandbox) CreateNamespacesWithFunc(managedNamespaces []NSType, cfg *config.Config, sysctls map[string]string, pinFunc func([]NSType, *config.Config, map[string]string) ([]NamespaceIface, error)) ([]*ManagedNamespace, error) {
