...
func (s *Sandbox) CreateManagedNamespaces(managedNamespaces []NSType, cfg *config.Config, sysctls map[string]string) ([]*ManagedNamespace, error) {
	return s.CreateNamespacesWithFunc(managedNamespaces, cfg, sysctls, pinNamespaces)
}
...
func (s *Sandbox) CreateNamespacesWithFunc(managedNamespaces []NSType, cfg *config.Config, sysctls map[string]string, pinFunc func([]NSType, *config.Config, map[string]string) ([]NamespaceIface, error)) (mns []*ManagedNamespace, retErr error) {
