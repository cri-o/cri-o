...
func generateContainerDiskMetrics(
	ctr *oci.Container,
	...
	diskMetrics := []*containerMetric{
		{
			...
			valueFunc: func() metricValues {
				return metricValues{
					{value: diskStats.InodesFree, metricType: types.MetricType_GAUGE},
				}
			},
		},
		{
			...
			valueFunc: func() metricValues {
				return metricValues{
					{value: diskStats.InodesTotal, metricType: types.MetricType_GAUGE},
				}
			},
		},
		{
			...
			valueFunc: func() metricValues {
				return metricValues{
					{value: diskStats.LimitBytes, metricType: types.MetricType_GAUGE},
				}
			},
		},
		{
			...
			valueFunc: func() metricValues {
				return metricValues{
					{value: diskStats.UsageBytes, metricType: types.MetricType_GAUGE},
				}
			},
		},
	}
...
func generateContainerDiskIOMetrics(
	ctr *oci.Container,
	ioStats *cgroups.BlkioStats,
) []*types.Metric {
	if ioStats == nil {
		return []*types.Metric{}
	}
	...
	for _, stat := range ioStats.IoServiceBytesRecursive {
		...
		diskMetrics = append(diskMetrics, &containerMetric{
			...
			valueFunc: func() metricValues {
				return metricValues{
					{value: stat.Value, labels: deviceLabels, metricType: types.MetricType_COUNTER},
				}
			},
		})
