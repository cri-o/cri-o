...
complete -c crio -n '__fish_crio_no_subcommand' -f -l image-content-cache-dir -r -d 'The directory where compressed layer blobs are cached for P2P image distribution.'
