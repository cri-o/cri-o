...
complete -c crio -n '__fish_crio_no_subcommand' -f -l metrics-cipher-suites -r -d 'Cipher suites to use for metrics endpoint. Valid values are listed on https://pkg.go.dev/crypto/tls#pkg-constants.'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l metrics-min-tls-version -r -d 'Minimum TLS version for the metrics endpoint. Valid values are VersionTLS10, VersionTLS11, VersionTLS12, VersionTLS13.'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l stream-cipher-suites -r -d 'Cipher suites to use for stream endpoint. Valid values are listed on https://pkg.go.dev/crypto/tls#pkg-constants.'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l stream-min-tls-version -r -d 'Minimum TLS version for the stream endpoint. Valid values are VersionTLS10, VersionTLS11, VersionTLS12, VersionTLS13.'
