...
complete -c crio -n '__fish_crio_no_subcommand' -l global-auth-file -r -d 'Path to a file like ~/.docker/config.json holding credentials necessary for pulling images from secure registries (default: "")'
