...
complete -c crio -n '__fish_crio_no_subcommand' -f -l automatic-reload-mirror-registry -d 'if true, CRI-O will automatically reload the mirror registry when there is an update to the \'registries.conf.d\' directory.'
