...
complete -c crio -n '__fish_crio_no_subcommand' -f -l root -s r -r -d 'crio root dir (default: "/var/lib/containers/storage")'
complete -c crio -n '__fish_crio_no_subcommand' -f -l runroot -r -d 'crio state dir (default: "/var/run/containers/storage")'
...
complete -c crio -n '__fish_crio_no_subcommand' -f -l storage-opt -r -d 'storage driver option (default: ["overlay.mountopt=nodev"])'
