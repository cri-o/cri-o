...
complete -c crio -n '__fish_crio_no_subcommand' -f -l allowed-annotations -r -d 'List of experimental annotations that every runtime handler is allowed to process. If set, overrides runtime handler specific allowed_annotations.'
