...
[v1.17.0-rc1...f0aef34](https://github.com/cri-o/cri-o/compare/v1.17.0-rc1...f0aef34b8dc8924175b2d7461004089ec6ea43f8) on Tue, 14 Apr 2020 19:27:06 UTC.

## Downloads

Download the static release bundle via our Google Cloud Bucket:
[crio-f0aef34b8.tar.gz][0]

[0]: https://storage.googleapis.com/k8s-conform-cri-o/artifacts/crio-f0aef34b8.tar.gz
...
- If a specified or the default hooks directory is not available, then we warn the user but do not fail any more. ([#3203](https://github.com/cri-o/cri-o/pull/3203), [@saschagrunert](https://github.com/saschagrunert))
...
- Fixed SIGHUP reload behavior for unqualified search registries ([#3209](https://github.com/cri-o/cri-o/pull/3209), [@saschagrunert](https://github.com/saschagrunert))
