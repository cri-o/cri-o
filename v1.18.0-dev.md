...
[v1.17.0...fd2e2cc](https://github.com/cri-o/cri-o/compare/v1.17.0...fd2e2ccf38b930d4dce2d4fbba91ff8a1beab226) on Wed, 25 Mar 2020 10:25:05 UTC.

## Downloads

Download the static release bundle via our Google Cloud Bucket:
[crio-fd2e2ccf3.tar.gz][0]

[0]: https://storage.googleapis.com/k8s-conform-cri-o/artifacts/crio-fd2e2ccf3.tar.gz

## Changes by Kind

### API Change

- CRI-O now runs containers without NET_RAW and SYS_CHROOT capabilities by default ([#3119](https://github.com/cri-o/cri-o/pull/3119), [@haircommander](https://github.com/haircommander))
