...
[v1.26.2...78941bf](https://github.com/cri-o/cri-o/compare/v1.26.2...78941bf056242b70780db738262a1e24a79b3e3a) on Wed, 12 Jul 2023 17:40:07 UTC.

## Downloads

Download one of our static release bundles via our Google Cloud Bucket:

- [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sha256sum)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sig)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.cert)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.sig)
  - [cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.cert)
- [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sha256sum)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sig)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.cert)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.sig)
  - [cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx.cert)

To verify the artifact signatures via [cosign](https://github.com/sigstore/cosign), run:

```console
> export COSIGN_EXPERIMENTAL=1
> cosign verify-blob cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz \
    --certificate-identity-regexp '.*' \
    --certificate-oidc-issuer-regexp '.*' \
    --signature cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.sig \
    --certificate cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.cert
```

To verify the bill of materials (SBOM) in [SPDX](https://spdx.org) format using the [bom](https://sigs.k8s.io/bom) tool, run:

```console
> tar xfz cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz
> bom validate -e cri-o.amd64.78941bf056242b70780db738262a1e24a79b3e3a.tar.gz.spdx -d cri-o
```
