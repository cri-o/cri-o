...
// NOTE: Do NOT export this type in the public `storage` package.
...
type StorageImageDestination struct {
	...
	indexLock         sync.Mutex              // Mutex to synchronize access to below fields
...
// is not supported.
func (s *StorageImageDestination) PutBlobWithOptions(ctx context.Context, stream io.Reader, blobinfo types.BlobInfo, options PutBlobOptions) (types.BlobInfo, error) {
...
// used the together.  Mixing the two with the non "WithOptions" functions
// is not supported.
func (s *StorageImageDestination) TryReusingBlobWithOptions(ctx context.Context, blobinfo types.BlobInfo, options TryReusingBlobOptions) (bool, types.BlobInfo, error) {
...
func (s *StorageImageDestination) commitLayer(ctx context.Context, blob manifest.LayerInfo, index int) error {
	...
	// Start with an empty string or the previous layer ID.
