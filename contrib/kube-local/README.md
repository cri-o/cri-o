...
| CONTAINER_ORCHESTRATION_GITHUB_URL| Container Orchestration github URL. Default **https://github.com/kubernetes/kubernetes**
...
| CONTAINER_ORCHESTRATION_KUBECONFIG_NAME| Kubeconfig filename. Default: **admin.kubeconfig**
| CONTAINER_ORCHESTRATION_KUBECONFIG_PATH| Full path for Kubeconfig. Default **/var/run/${CONTAINER_ORCHESTRATION_NAME}/${CONTAINER_ORCHESTRATION_KUBECONFIG_NAME}**
| CONTAINER_ORCHESTRATION_OUTPUT_DIR| Container Orchestration output dir. Default: **${CONTAINER_ORCHESTRATION_GOLANG_DIR}/_output/bin**
| CONTAINER_ORCHESTRATION_ETCD| Etcd path. Default **${CONTAINER_ORCHESTRATION_GOLANG_DIR}/third_party/etcd**
| CONTAINER_ORCHESTRATION_SERVICES| Container Orchestration services. Default: **kube-controller-manager kube-apiserver kubelet kube-scheduler etcd conmon**
...
| CONTAINER_NETWORK_GOLANG_DIR| Container Network Golang dir. Default: **${GOLANG_PROJECT_HOME_SRC}/${CONTAINER_NETWORK_GOLANG_SRC_GITHUB}/${CONTAINER_NETWORK_REPO_NAME}**
| CONTAINER_NETWORK_GITHUB_URL| Container Network Github URL. Default: https://github.com/containernetwork/plugins
| CONTAINER_NETWORK_VERSION| Container Network version. Example: master. Please note: No need to assign if using tag
| CONTAINER_NETWORK_TAG| Container Network tag. Default: **v0.8.1**
| CONTAINER_NETWORK_CNI_PATH| Container Network CNI path. Default: **/opt/cni**
| CONTAINER_NETWORK_CNI_PATH_BIN| Container Network CNI Bin path. Default: **${CONTAINER_NETWORK_CNI_PATH}/bin**
| CONTAINER_NETWORK_PLUGINS| Container Network plugins: Default: **bandwidth bridge firewall flannel host-device ipvlan loopback macvlan portmap ptp sbr tuning vlan**
