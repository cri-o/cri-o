...
[v1.19.0...32cfb72](https://github.com/cri-o/cri-o/compare/v1.19.0...32cfb729bed8d5d17aaa421dd83b518302b76d8e) on Sat, 16 Jan 2021 00:39:50 UTC.

## Downloads

Download the static release bundle via our Google Cloud Bucket:
[crio-32cfb729b.tar.gz][0]

[0]: https://storage.googleapis.com/k8s-conform-cri-o/artifacts/crio-32cfb729b.tar.gz
...
#### Uncategorized
 ...
 - Update nix pin with `make nixpkgs` ([#4184](https://github.com/cri-o/cri-o/pull/4184), [@hswong3i](https://github.com/hswong3i))
...
- github.com/containers/image/v5: [v5.5.1 → v5.9.0](https://github.com/containers/image/v5/compare/v5.5.1...v5.9.0)
- github.com/containers/psgo: [v1.4.0 → v1.5.1](https://github.com/containers/psgo/compare/v1.4.0...v1.5.1)
- github.com/containers/storage: [v1.20.2 → v1.24.4](https://github.com/containers/storage/compare/v1.20.2...v1.24.4)
...
- github.com/klauspost/compress: [v1.10.8 → v1.11.6](https://github.com/klauspost/compress/compare/v1.10.8...v1.11.6)
