...
[v1.25.1...v1.25.2](https://github.com/cri-o/cri-o/compare/v1.25.1...v1.25.2) on Tue, 10 Jan 2023 17:56:14 UTC.

## Downloads

Download one of our static release bundles via our Google Cloud Bucket:

- [cri-o.amd64.v1.25.2.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.v1.25.2.tar.gz)
  - [cri-o.amd64.v1.25.2.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.v1.25.2.tar.gz.sha256sum)
  - [cri-o.amd64.v1.25.2.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.v1.25.2.tar.gz.sig)
  - [cri-o.amd64.v1.25.2.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.v1.25.2.tar.gz.cert)
  - [cri-o.amd64.v1.25.2.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.amd64.v1.25.2.tar.gz.spdx)
- [cri-o.arm64.v1.25.2.tar.gz](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.v1.25.2.tar.gz)
  - [cri-o.arm64.v1.25.2.tar.gz.sha256sum](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.v1.25.2.tar.gz.sha256sum)
  - [cri-o.arm64.v1.25.2.tar.gz.sig](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.v1.25.2.tar.gz.sig)
  - [cri-o.arm64.v1.25.2.tar.gz.cert](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.v1.25.2.tar.gz.cert)
  - [cri-o.arm64.v1.25.2.tar.gz.spdx](https://storage.googleapis.com/cri-o/artifacts/cri-o.arm64.v1.25.2.tar.gz.spdx)

To verify the artifact signatures via [cosign](https://github.com/sigstore/cosign), run:

```console
> export COSIGN_EXPERIMENTAL=1
> cosign verify-blob cri-o.amd64.v1.25.2.tar.gz \
    --signature cri-o.amd64.v1.25.2.tar.gz.sig \
    --certificate cri-o.amd64.v1.25.2.tar.gz.cert
```

To verify the bill of materials (SBOM) in [SPDX](https://spdx.org) format using the [bom](https://sigs.k8s.io/bom) tool, run:

```console
> tar xfz cri-o.amd64.v1.25.2.tar.gz
> bom validate -e cri-o.amd64.v1.25.2.tar.gz.spdx -d cri-o
```
