...
[v1.20.0...2a69f9f](https://github.com/cri-o/cri-o/compare/v1.20.0...2a69f9fe48b3c168155f7acd4e5d46d478236b89) on Tue, 23 Mar 2021 13:23:07 UTC.

## Downloads

Download one of our static release bundles via our Google Cloud Bucket:

- [cri-o.amd64.2a69f9fe48b3c168155f7acd4e5d46d478236b89.tar.gz](https://storage.googleapis.com/k8s-conform-cri-o/artifacts/cri-o.amd64.2a69f9fe48b3c168155f7acd4e5d46d478236b89.tar.gz)
- [cri-o.arm64.2a69f9fe48b3c168155f7acd4e5d46d478236b89.tar.gz](https://storage.googleapis.com/k8s-conform-cri-o/artifacts/cri-o.arm64.2a69f9fe48b3c168155f7acd4e5d46d478236b89.tar.gz)
...
- github.com/containers/podman/v3: [v3.1.0-rc1](https://github.com/containers/podman/v3/tree/v3.1.0-rc1)
...
- github.com/moby/sys/mount: [v0.1.1](https://github.com/moby/sys/mount/tree/v0.1.1)
...
- github.com/containers/buildah: [v1.15.2 → v1.19.8](https://github.com/containers/buildah/compare/v1.15.2...v1.19.8)
- github.com/containers/common: [v0.21.0 → v0.35.2](https://github.com/containers/common/compare/v0.21.0...v0.35.2)
- github.com/containers/image/v5: [v5.7.0 → v5.10.5](https://github.com/containers/image/v5/compare/v5.7.0...v5.10.5)
...
- github.com/containers/storage: [v1.24.0 → v1.28.0](https://github.com/containers/storage/compare/v1.24.0...v1.28.0)
...
- github.com/coreos/go-systemd/v22: [v22.1.0 → v22.2.0](https://github.com/coreos/go-systemd/v22/compare/v22.1.0...v22.2.0)
- github.com/cri-o/ocicni: [513ef78 → 541cf7c](https://github.com/cri-o/ocicni/compare/513ef78...541cf7c)
- github.com/docker/docker: [bd33bbf → b6bfff2](https://github.com/docker/docker/compare/bd33bbf...b6bfff2)
...
- github.com/fsouza/go-dockerclient: [v1.6.5 → v1.6.6](https://github.com/fsouza/go-dockerclient/compare/v1.6.5...v1.6.6)
...
- github.com/klauspost/compress: [v1.11.2 → v1.11.12](https://github.com/klauspost/compress/compare/v1.11.2...v1.11.12)
- github.com/mattn/go-isatty: [v0.0.12 → v0.0.11](https://github.com/mattn/go-isatty/compare/v0.0.12...v0.0.11)
...
- github.com/onsi/ginkgo: [v1.14.1 → v1.15.2](https://github.com/onsi/ginkgo/compare/v1.14.1...v1.15.2)
...
- github.com/openshift/imagebuilder: [v1.1.6 → v1.1.8](https://github.com/openshift/imagebuilder/compare/v1.1.6...v1.1.8)
...
- golang.org/x/sys: 5cba982 → 3901687
...
- k8s.io/kubernetes/staging/src/k8s.io/api: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/apiextensions-apiserver: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/apimachinery: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/apiserver: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/cli-runtime: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/client-go: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/cloud-provider: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/cluster-bootstrap: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/code-generator: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/component-base: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/component-helpers: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/controller-manager: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/cri-api: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/csi-translation-lib: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kube-aggregator: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kube-controller-manager: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kube-proxy: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kube-scheduler: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kubectl: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/kubelet: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/legacy-cloud-providers: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/metrics: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/mount-utils: 3321f00 → 40a411a
- k8s.io/kubernetes/staging/src/k8s.io/sample-apiserver: 3321f00 → 40a411a
- k8s.io/kubernetes: v1.20.0-rc.0 → v1.21.0-beta.1
